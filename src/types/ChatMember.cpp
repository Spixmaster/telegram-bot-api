		...
		if(doc.IsObject())
		{
			...
			if(doc.HasMember("status"))
			{
				if(doc["status"].IsString())
					...
					std::cerr << Messages::field_does_not_contain_string("status") << std::endl;
			}
			...
			if(doc.HasMember("custom_title"))
			{
				if(doc["custom_title"].IsString())
					...
					std::cerr << Messages::field_does_not_contain_string("custom_title") << std::endl;
			}
			...
			if(doc.HasMember("until_date"))
			{
				if(doc["until_date"].IsInt())
					...
					std::cerr << Messages::field_does_not_contain_int("until_date") << std::endl;
			}
			...
			if(doc.HasMember("can_be_edited"))
			{
				if(doc["can_be_edited"].IsBool())
					...
					std::cerr << Messages::field_does_not_contain_bool("can_be_edited") << std::endl;
			}
			...
			if(doc.HasMember("can_post_messages"))
			{
				if(doc["can_post_messages"].IsBool())
					...
					std::cerr << Messages::field_does_not_contain_bool("can_post_messages") << std::endl;
			}
			...
			if(doc.HasMember("can_edit_messages"))
			{
				if(doc["can_edit_messages"].IsBool())
					...
					std::cerr << Messages::field_does_not_contain_bool("can_edit_messages") << std::endl;
			}
			...
			if(doc.HasMember("can_delete_messages"))
			{
				if(doc["can_delete_messages"].IsBool())
					...
					std::cerr << Messages::field_does_not_contain_bool("can_delete_messages") << std::endl;
			}
			...
			if(doc.HasMember("can_restrict_members"))
			{
				if(doc["can_restrict_members"].IsBool())
					...
					std::cerr << Messages::field_does_not_contain_bool("can_restrict_members") << std::endl;
			}
			...
			if(doc.HasMember("can_promote_members"))
			{
				if(doc["can_promote_members"].IsBool())
					...
					std::cerr << Messages::field_does_not_contain_bool("can_promote_members") << std::endl;
			}
			...
			if(doc.HasMember("is_member"))
			{
				if(doc["is_member"].IsBool())
					...
					std::cerr << Messages::field_does_not_contain_bool("is_member") << std::endl;
			}
			...
			if(doc.HasMember("can_add_web_page_previews"))
			{
				if(doc["can_add_web_page_previews"].IsBool())
					...
					std::cerr << Messages::field_does_not_contain_bool("can_add_web_page_previews") << std::endl;
			}
		}
		else
