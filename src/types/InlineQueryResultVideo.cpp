	...
	InlineQueryResultVideo::InlineQueryResultVideo(const std::string &json)
	{
		...
		if(doc.IsObject())
		{
			...
			if(doc.HasMember("video_url"))
				...
				std::cerr << "Error: There is no field \"video_url\"." << std::endl;
			...
			if(doc.HasMember("video_width"))
				...
				std::cerr << "Error: There is no field \"video_width\"." << std::endl;
			...
			if(doc.HasMember("video_height"))
				...
				std::cerr << "Error: There is no field \"video_height\"." << std::endl;
			...
			if(doc.HasMember("video_duration"))
				...
				std::cerr << "Error: There is no field \"video_duration\"." << std::endl;
