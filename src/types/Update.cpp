	...
	Update::Update(std::string json)
	{
		...
		if(doc.IsObject())
		{
			...
			if(doc.HasMember("update_id"))
				...
				std::cerr << "Error: There is no field \"update_id\"." << std::endl;
			...
			if(doc.HasMember("edited_message"))
				...
				std::cerr << "Error: There is no field \"edited_message\"." << std::endl;
			...
			if(doc.HasMember("channel_post"))
				...
				std::cerr << "Error: There is no field \"channel_post\"." << std::endl;
			...
			if(doc.HasMember("edited_channel_post"))
				...
				std::cerr << "Error: There is no field \"edited_channel_post\"." << std::endl;
			...
			if(doc.HasMember("inline_query"))
				...
				std::cerr << "Error: There is no field \"inline_query\"." << std::endl;
			...
			if(doc.HasMember("chosen_inline_result"))
				...
				std::cerr << "Error: There is no field \"chosen_inline_result\"." << std::endl;
			...
			if(doc.HasMember("callback_query"))
				...
				std::cerr << "Error: There is no field \"callback_query\"." << std::endl;
			...
			if(doc.HasMember("shipping_query"))
				...
				std::cerr << "Error: There is no field \"shipping_query\"." << std::endl;
			...
			if(doc.HasMember("pre_checkout_query"))
				...
				std::cerr << "Error: There is no field \"pre_checkout_query\"." << std::endl;
			...
			if(doc.HasMember("poll_answer"))
				...
				std::cerr << "Error: There is no field \"poll_answer\"." << std::endl;
		}
		else
