	...
	User::User(const std::string &json)
	{
		...
		if(doc.IsObject())
		{
			...
			if(doc.HasMember("is_bot"))
				...
				std::cerr << "Error: There is no field \"is_bot\"." << std::endl;
			...
			if(doc.HasMember("language_code"))
				...
				std::cerr << "Error: There is no field \"language_code\"." << std::endl;
			...
			if(doc.HasMember("can_join_groups"))
				...
				std::cerr << "Error: There is no field \"can_join_groups\"." << std::endl;
			...
			if(doc.HasMember("can_read_all_group_messages"))
				...
				std::cerr << "Error: There is no field \"can_read_all_group_messages\"." << std::endl;
			...
			if(doc.HasMember("supports_inline_queries"))
				...
				std::cerr << "Error: There is no field \"supports_inline_queries\"." << std::endl;
		}
		else
