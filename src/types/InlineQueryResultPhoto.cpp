	...
	InlineQueryResultPhoto::InlineQueryResultPhoto(const std::string &json)
	{
		...
		if(doc.IsObject())
		{
			...
			if(doc.HasMember("photo_url"))
				...
				std::cerr << "Error: There is no field \"photo_url\"." << std::endl;
			...
			if(doc.HasMember("photo_width"))
				...
				std::cerr << "Error: There is no field \"photo_width\"." << std::endl;
			...
			if(doc.HasMember("photo_height"))
				...
				std::cerr << "Error: There is no field \"photo_height\"." << std::endl;
			...
			if(doc.HasMember("input_message_content"))
				...
				std::cerr << "Error: There is no field \"input_message_content\"." << std::endl;
		}
		else
